  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-6">About MRISA</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
            ...
            <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
              <h2 className="text-2xl font-display font-bold text-foreground mb-4">History</h2>
          ...
          <div className="border-t border-border pt-12">
            <h2 className="text-2xl font-display font-bold text-foreground mb-8">What We Do</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="bg-card border border-border p-6 rounded-lg shadow-sm">
                  <h3 className="text-lg font-bold text-foreground mb-2">{item.h}</h3>
                  <p className="text-muted-foreground text-sm">{item.t}</p>
                </div>
              ))}
            </div>
          </div>
